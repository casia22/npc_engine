...
# Initialize the output parser based on the response schemas
output_parser = StructuredOutputParser.from_response_schemas(response_schemas)

# Get the format instructions from the parser
format_instructions = output_parser.get_format_instructions()

# Create a prompt template with the given format
...
# Use the OpenAI model to generate a response based on the formatted prompt
output = get_model_answer(model_name='gpt-3.5-turbo-16k', inputs_list=query,
